...
if [ "$OMR_OPENWRT" = "default" ]; then
	if [ "$OMR_KERNEL" = "5.4" ]; then
		...
		_get_repo feeds/${OMR_KERNEL}/ipq807x https://github.com/suyuan168/ipq807x "master"
		_get_repo feeds/${OMR_KERNEL}/axwifi https://github.com/suyuan168/axwifi "master"
...
src-link ipq807x $(readlink -f feeds/${OMR_KERNEL}/ipq807x)
src-link axwifi $(readlink -f feeds/${OMR_KERNEL}/axwifi)
